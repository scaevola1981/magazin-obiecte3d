  ...
  return (
    ...
    >
      <body className="min-h-full flex flex-col bg-white overflow-x-hidden">
        ...
        <div className="fixed inset-0 pointer-events-none z-[9999] opacity-[0.03] bg-[url('https://grainy-gradients.vercel.app/noise.svg')] brightness-100 contrast-150"></div>
        {children}
      </body>
    </html>
  );
